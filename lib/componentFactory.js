...
module.exports = function (element) {
  ...
  switch (element[0].name) {
    ...
    case this.components.button:
      ...
      return format(
        '<table class="%s" role="presentation"><tbody><tr><td><table><tbody><tr><td>%s</td></tr></tbody></table></td>%s</tr></tbody></table>',
        classes.join(" "),
        inner,
        expander
      );
    ...
    case this.components.menu:
      ...
      return format(
        '<table %s class="%s" role="presentation"><tbody><tr><td><table><tbody><tr>%s</tr></tbody></table></td></tr></tbody></table>',
        attrs,
        classes.join(" "),
        inner
      );
