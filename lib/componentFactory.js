...
module.exports = function(element) {
  ...
  this.getAttrs = function() {
    ...
    var ignoredAttributes = ['class', 'id', 'href', 'size'];
    var result = '';
  ...
  switch (element[0].name) {
    ...
    case this.components.row:
      ...
      return format('<table %s class="%s"><tbody><tr>%s</tr></tbody></table>', this.getAttrs(), classes.join(' '), inner);
    ...
    case this.components.container:
      ...
      return format('<table %s class="%s"><tbody><tr><td>%s</td></tr></tbody></table>', this.getAttrs(), classes.join(' '), inner);
    ...
    case this.components.menu:
      ...
      return format('<table %s class="%s"%s><tr><td><table><tr>%s</tr></table></td></tr></table>', this.getAttrs(), classes.join(' '), centerAttr, inner);
    ...
    case this.components.menuItem:
      ...
      return format('<th %s class="%s"><a href="%s">%s</a></th>', this.getAttrs(), classes.join(' '), element.attr('href'), inner);
    ...
    case this.components.callout:
      ...
      return format('<table %s class="callout"><tr><th class="%s">%s</th><th class="expander"></th></tr></table>', this.getAttrs(), classes.join(' '), inner);
    ...
    case this.components.spacer:
      ...
      return format('<table %s class="%s"><tbody><tr><td height="'+size+'px" style="font-size:'+size+'px;line-height:'+size+'px;">&#xA0;</td></tr></tbody></table>', this.getAttrs(), classes.join(' '), inner);
    ...
    case this.components.wrapper:
      ...
      return format('<table %s class="%s" align="center"><tr><td class="wrapper-inner">%s</td></tr></table>', this.getAttrs(), classes.join(' '), inner);
