...
module.exports = function(element) {
  ...
  switch (element[0].name) {
    ...
    case this.components.button:
      ...
      return format('<table class="%s"><tr><td><table><tr><td>%s</td></tr></table></td></tr></table>', classes.join(' '), classes.join(' '), inner);
    ...
    case this.components.callout:
      ...
      return format('<table class="callout" ><tr><th class="%s">%s</th></tr></table>', classes.join(' '), inner);
