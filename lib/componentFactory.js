...
module.exports = function(element) {
  ...
  switch (element[0].name) {
    ...
    case this.components.button:
      ...
      return format('<table class="%s"><tr><td><table><tr><td>%s</td>%s</tr></table></td></tr></table>', classes.join(' '), inner, expander);
    ...
    case this.components.callout:
      ...
      return format('<table class="callout"><tr><td class="%s">%s</td><td class="expander"></td></tr></table>', classes.join(' '), inner);
