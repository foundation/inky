...
describe("the grid", function () {
  ...
  it("nests subcolumns correctly", function() {
    ...
    $ = inky.releaseTheKraken($);
    expect($.html()).toEqual('<center><table class="row"><tbody><tr><td class="wrapper"><table class="small-12 large-6 columns"><td class="sub-columns small-12 large-4"><h3>Sub column 1</h3></td><td class="expander"></td><td class="sub-columns last small-12 large-8"><h3>Sub column 2</h3></td><td class="expander"></td></table></td><td class="wrapper last"><table class="small-12 large-6 columns"><td class="sub-columns small-12 large-6"><h3>Sub column 1.1</h3></td><td class="expander"></td><td class="sub-columns last small-12 large-6"><h3>Sub column 1.2</h3></td><td class="expander"></td></table></td></tr></tbody></table></center>');
  });
  ...
  it("nests rows in containers", function() {
    ...
    $ = inky.releaseTheKraken($);
    expect($.html()).toEqual('<center><table class="container"><tbody><tr><td><table class="row"><tbody><tr>Row in container</tr></tbody></table></td></tr></tbody></table></center>');
  })
  ...
  it("will place the 'last' class on the last column", function() {
    ...
    $ = inky.releaseTheKraken($);
    expect($.html()).toEqual('<center><table class="row"><tbody><tr><td class="wrapper"><table class="small-12 large-10 columns"><tr><td>.ten cols</td><td class="expander"></td></tr></table></td><td class="wrapper last"><table class="small-12 large-2 columns"><tr><td>.two cols</td><td class="expander"></td></tr></table></td></tr></tbody></table></center>');
